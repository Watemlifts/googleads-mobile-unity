...
#region BANNER ADS
  ...
  public void RequestBannerAd() {
    ...
    bannerView.OnAdFailedToLoad += (sender, args) =>
        LogOnMainThread("GMA BannerView OnAdFailedToLoad");
...
#region INTERSTITIAL ADS
  ...
  public void RequestAndLoadInterstitialAd() {
    ...
    interstitialAd.OnAdFailedToLoad += (sender, args) =>
        LogOnMainThread("GMA InterstitialAd OnAdFailedToLoad");
    interstitialAd.OnAdOpening += (sender, args) =>
        LogOnMainThread("GMA InterstitialAd OnAdOpening");
    ...
    interstitialAd.OnPaidEvent += (sender, args) =>
        LogOnMainThread("GMA InterstitialAd OnPaidEvent");
    interstitialAd.OnAdDidRecordImpression += (sender, args) =>
        LogOnMainThread("GMA InterstitialAd OnAdDidRecordImpression");
    interstitialAd.OnAdFailedToShow += (sender, args) =>
        LogOnMainThread("GMA InterstitialAd OnAdFailedToShow");
...
#region REWARDED ADS
  ...
  public void RequestAndLoadRewardedAd() {
    ...
    rewardedAd.OnAdFailedToLoad += (sender, args) =>
        LogOnMainThread("GMA RewardedAd OnAdFailedToLoad");
    ...
    rewardedAd.OnAdDidRecordImpression += (sender, args) =>
        LogOnMainThread("GMA RewardedAd OnAdDidRecordImpression");
    rewardedAd.OnAdFailedToShow += (sender, args) =>
        LogOnMainThread("GMA RewardedAd OnAdFailedToShow");
    rewardedAd.OnUserEarnedReward += (sender, args) =>
        LogOnMainThread("GMA RewardedAd OnUserEarnedReward");
  ...
  public void RequestAndLoadRewardedInterstitialAd() {
    ...
    RewardedInterstitialAd.LoadAd(adUnitId, CreateAdRequest(), (rewardedInterstitialAd, error) => {
      ...
      rewardedInterstitialAd.OnAdDidDismissFullScreenContent += (sender, args) =>
          LogOnMainThread("GMA RewardedInterstitial OnAdDidDismissFullScreenContent");
      rewardedInterstitialAd.OnAdDidPresentFullScreenContent += (sender, args) =>
          LogOnMainThread("GMA RewardedInterstitial OnAdDidPresentFullScreenContent");
      rewardedInterstitialAd.OnAdDidRecordImpression += (sender, args) =>
          LogOnMainThread("GMA RewardedInterstitial OnAdDidRecordImpression");
      rewardedInterstitialAd.OnAdFailedToPresentFullScreenContent += (sender, args) =>
          LogOnMainThread("GMA RewardedInterstitialOnAdFailedToPresentFullScreenContent");
      rewardedInterstitialAd.OnPaidEvent += (sender, args) =>
          LogOnMainThread("GMA RewardedInterstitial OnPaidEvent");
    });
  }
...
#region APPOPEN ADS
  ...
  public void RequestAndLoadAppOpenAd() {
    ...
    AppOpenAd.LoadAd(
        adUnitId, ScreenOrientation.Portrait, CreateAdRequest(), (appOpenAd, error) => {
          if (error != null) {
          ...
          appOpenAd.OnAdDidDismissFullScreenContent += (sender, args) =>
              LogOnMainThread("GMA AppOpen OnAdDidDismissFullScreenContent");
          appOpenAd.OnAdDidPresentFullScreenContent += (sender, args) =>
              LogOnMainThread("GMA AppOpen OnAdDidPresentFullScreenContent");
          appOpenAd.OnAdDidRecordImpression += (sender, args) =>
              LogOnMainThread("GMA AppOpen OnAdDidRecordImpression");
          appOpenAd.OnAdFailedToPresentFullScreenContent += (sender, args) =>
              LogOnMainThread("GMA AppOpen OnAdFailedToPresentFullScreenContent");
