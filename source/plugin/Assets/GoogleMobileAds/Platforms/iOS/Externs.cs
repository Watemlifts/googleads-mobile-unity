...
#region Common externs
    ...
    [DllImport("__Internal")]
    internal static extern void GADUMutableDictionarySetValue(IntPtr mutableDictionaryPtr,
                                                              string key, string value);

    [DllImport("__Internal")]
    internal static extern void GADUSetMediationExtras(IntPtr request, IntPtr mutableDictionaryPtr,
...
#region AppOpenAd externs
    ...
    [DllImport("__Internal")]
    internal static extern void GADULoadAppOpenAd(IntPtr appOpenAd, string adUnitID,
                                                  int orientation, IntPtr request);
    ...
    internal static extern void GADUSetAppOpenAdCallbacks(
        IntPtr appOpenAd, AppOpenAdClient.GADUAppOpenAdLoadedCallback adLoadedCallback,
        ...
        AppOpenAdClient.GADUAppOpenAdDidRecordImpressionCallback adDidRecordImpressionCallback);
...
#region Banner externs
    ...
    [DllImport("__Internal")]
    internal static extern IntPtr GADUCreateBannerView(IntPtr bannerClient, string adUnitId,
                                                       int width, int height, int positionAtTop);

    [DllImport("__Internal")]
    internal static extern IntPtr GADUCreateBannerViewWithCustomPosition(IntPtr bannerClient,
                                                                         string adUnitId, int width,
                                                                         int height, int x, int y);

    [DllImport("__Internal")]
    internal static extern IntPtr GADUCreateSmartBannerView(IntPtr bannerClient, string adUnitId,
                                                            int positionAtTop);

    [DllImport("__Internal")]
    internal static extern IntPtr GADUCreateSmartBannerViewWithCustomPosition(IntPtr bannerClient,
                                                                              string adUnitId,
                                                                              int x, int y);

    [DllImport("__Internal")]
    internal static extern IntPtr GADUCreateAnchoredAdaptiveBannerView(IntPtr bannerClient,
                                                                       string adUnitId, int width,
                                                                       int orientation,
                                                                       int positionAtTop);
    ...
    internal static extern void GADUSetBannerCallbacks(
        IntPtr bannerView, BannerClient.GADUAdViewDidReceiveAdCallback adReceivedCallback,
...
#region Interstitial externs
    ...
    internal static extern void GADUSetInterstitialCallbacks(
        IntPtr interstitial, InterstitialClient.GADUInterstitialAdLoadedCallback adReceivedCallback,
...
#region RewardedAd externs
    ...
    internal static extern void GADUSetRewardedAdCallbacks(
        ...
        RewardedAdClient.GADURewardedAdDidDismissFullScreenContentCallback
            adDidDismissFullScreenContentCallback,
        RewardedAdClient.GADURewardedAdDidRecordImpressionCallback adDidRecordImpressionCallback,
    ...
    [DllImport("__Internal")]
    internal static extern void GADUServerSideVerificationOptionsSetUserId(IntPtr options,
                                                                           string userId);
    ...
    [DllImport("__Internal")]
    internal static extern void GADURewardedAdSetServerSideVerificationOptions(IntPtr rewardedAd,
                                                                               IntPtr options);
...
#region RewardedInterstitialAd externs
    ...
    internal static extern void GADUSetRewardedInterstitialAdCallbacks(
        ...
        RewardedInterstitialAdClient.GADURewardedInterstitialAdDidDismissFullScreenContentCallback
            adUnitIDdDidDismissFullScreenContentCallback,
        RewardedInterstitialAdClient
            .GADURewardedInterstitialAdUserEarnedRewardCallback adDidEarnRewardCallback,
