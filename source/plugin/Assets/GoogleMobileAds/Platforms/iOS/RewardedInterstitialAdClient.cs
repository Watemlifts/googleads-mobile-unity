...
#region rewarded interstitial ad callback types
    ...
    internal delegate void GADURewardedInterstitialAdLoadedCallback(
...
#region full screen content callback types
    ...
    internal delegate void GADURewardedInterstitialAdWillPresentFullScreenContentCallback(
        IntPtr rewardedInterstitialAdClient);

    internal delegate void GADURewardedInterstitialAdDidDismissFullScreenContentCallback(
        IntPtr rewardedInterstitialAdClient);
    internal delegate void GADURewardedInterstitialAdDidRecordImpressionCallback(
        IntPtr rewardedInterstitialAdClient);
    ...
    private IntPtr RewardedInterstitialAdPtr {
      get { return this.rewardedInterstitialAdPtr; }
...
#region IRewardedInterstitialAdClient implementation
    ...
    public void CreateRewardedInterstitialAd() {
      ...
      this.RewardedInterstitialAdPtr =
          Externs.GADUCreateRewardedInterstitialAd(this.rewardedInterstitialAdClientPtr);

      Externs.GADUSetRewardedInterstitialAdCallbacks(
          this.RewardedInterstitialAdPtr, RewardedInterstitialAdLoadedCallback,
          RewardedInterstitialAdFailedToLoadCallback, AdFailedToPresentFullScreenContentCallback,
          AdWillPresentFullScreenContentCallback, AdDidDismissFullScreenContentCallback,
          RewardedInterstitialAdUserDidEarnRewardCallback, RewardedInterstitialAdPaidEventCallback,
    ...
    public void SetServerSideVerificationOptions(
      ...
      Externs.GADURewardedInterstitialAdSetServerSideVerificationOptions(
          this.RewardedInterstitialAdPtr, optionsPtr);
    ...
    public Reward GetRewardItem() {
      ...
      double amount =
          Externs.GADURewardedInterstitialAdGetRewardAmount(this.RewardedInterstitialAdPtr);
      ;
      return new Reward() { Type = type, Amount = amount };
    }
...
#region rewarded interstitial ad callback methods
    ...
    private static void RewardedInterstitialAdFailedToLoadCallback(
      ...
      if (client.OnAdFailedToLoad != null) {
        LoadAdErrorClientEventArgs args =
            new LoadAdErrorClientEventArgs() { LoadAdErrorClient = new LoadAdErrorClient(error) };
    ...
    private static void RewardedInterstitialAdUserDidEarnRewardCallback(
      ...
      if (client.OnUserEarnedReward != null) {
        Reward args = new Reward() { Type = rewardType, Amount = rewardAmount };
        client.OnUserEarnedReward(client, args);
      }
    }

    [MonoPInvokeCallback(typeof(GADURewardedInterstitialAdPaidEventCallback))]
    private static void RewardedInterstitialAdPaidEventCallback(IntPtr rewardedInterstitialAdClient,
      ...
      if (client.OnPaidEvent != null) {
        ...
        AdValueEventArgs args = new AdValueEventArgs() { AdValue = adValue };
    ...
    [MonoPInvokeCallback(
        typeof(GADURewardedInterstitialAdFailedToPresentFullScreenContentCallback))]
    private static void AdFailedToPresentFullScreenContentCallback(
      ...
      if (client.OnAdFailedToPresentFullScreenContent != null) {
        AdErrorClientEventArgs args =
            new AdErrorClientEventArgs() { AdErrorClient = new AdErrorClient(error) };
    ...
    private static void AdWillPresentFullScreenContentCallback(
        IntPtr rewardedInterstitialAdClient) {
      RewardedInterstitialAdClient client =
          IntPtrToRewardedInterstitialAdClient(rewardedInterstitialAdClient);
